...
public class studentReport extends JFrame implements ActionListener {
	...
	JLabel l1 = new JLabel("Student Registered in the System");
	l1.setForeground(new Color(107, 142, 35));
	l1.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 25));
    ...
    if (excelChooser == JFileChooser.APPROVE_OPTION){
         ...
         try {
            excelJTableExporter = new XSSFWorkbook();
             XSSFSheet excelsheet= excelJTableExporter.createSheet("Student Records");
             ...
             JOptionPane.showMessageDialog(null,"Student Details Exported Successfully.");
