...
public class Signup extends JFrame implements ActionListener{
	...
	textField_4.setBounds(265, 276, 148, 20);
        textField_4.setText("Employee");
        textField_4.setEditable(false);
	contentPane.add(textField_4);
        
        JLabel lbl4 = new JLabel("Default User-Type:");
	lbl4.setForeground(Color.DARK_GRAY);
	lbl4.setFont(new Font("Tahoma", Font.BOLD, 14));
	lbl4.setBounds(99, 276, 150, 26);
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            if(ae.getSource() == b1){
                String sql = "insert into account(username, name, password, sec_q, sec_ans, user_type) values(?, ?, ?, ?, ?, ?)";
