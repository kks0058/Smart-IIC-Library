...
public class adminEPanel extends JFrame implements ActionListener {
	...
	public static void main(String[] args) {
            ...
            mntmback.setBackground(new Color(211, 211, 211));
            mntmback.setForeground(new Color(105, 105, 105));
