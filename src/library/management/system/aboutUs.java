...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : Itahari International College");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 25));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("Contact Us : iic@edu.np");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("Contact Details: SundarHaraicha, Morang.");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            
            	JLabel l21 = new JLabel("Back");
