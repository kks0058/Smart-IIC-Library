...
public class Manage_Accounts extends JFrame implements ActionListener {
 ...
 public Manage_Accounts(){
	...
	JLabel l1 = new JLabel("Manage User-Accounts");
	l1.setForeground(new Color(107, 142, 35));
	l1.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 24));
	...
	panel.setBorder(new TitledBorder(new LineBorder(new Color(0, 128, 128), 3, true), "Employee Details",
 ...
 public void Accounts(){
	try {
            conn con = new conn();
            String sql = "select * from Account where user_type = 'Employee'";
