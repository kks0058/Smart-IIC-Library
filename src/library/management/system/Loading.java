...
public class Loading extends JFrame implements Runnable {
	...
	public Loading() {
            ...
            JLabel lbllibraryManagement = new JLabel("Smart IIC Library v1.1");
            ...
            progressBar.setBounds(130, 135, 330, 25);
            contentPane.add(progressBar);

            JLabel lblNewLabel_2 = new JLabel("Please Wait (Loading Environment)");
            lblNewLabel_2.setFont(new Font("Yu Gothic UI Semibold", Font.BOLD, 20));
            lblNewLabel_2.setForeground(new Color(160, 82, 45));
            lblNewLabel_2.setBounds(130, 165, 330, 20);
